...
<body class="flex flex-col justify-center items-center h-screen text-center">
  ...
  <!-- About Section -->
  <section id="about" class="glass mt-20 max-w-3xl mx-auto text-green-200">
  ...
  <!-- Contact -->
  <footer class="glass text-center py-4 mt-12 text-green-300">
  ...
  <script>
    ...
    function draw() {
      ...
      ctx.fillStyle = "rgba(0,255,0,0.6)"; // dimmer background code
